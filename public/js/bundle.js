...
var bookPlan = exports.bookPlan = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(planId) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51OUXCgIIICW1mkAIzq94x5iTlCr2EiegIGg4Qx797h1HFh5YDyuokLOTYi3K6rnUfpaK1e8OLkegZhDqjxCtl4dJ00Ndwgs9xj');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(planId));
        case 4:
...
var bookBtn = document.getElementById('book-plan');
